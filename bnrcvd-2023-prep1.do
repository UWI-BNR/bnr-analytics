...
** --------------------------------------------------------------
** Dataset released on 23-OCT-2025
** JC Location: (sync.com) .\CVD Refit\Annual Report\Datasets\2009-2023\3-output
** For dataset details, see : https://uwi-bnr.github.io/bnr-refit/02_Data/structure/   
use "${data}\2009-2023_identifiable_restructured_cvd_30Oct2025_v1.dta", clear 
...
** Associated YAML metadata file - create and save
   local dataset "${tempdata}\bnr-cvd-full-${today}-prep1.dta"
   * Generate YAML
...
preserve
   ...
   note : Date created = ${todayiso}
   note : Input dataset created by J.Campbell, 25-Oct-2025 
   save "${tempdata}\bnr-cvd-count-${today}-prep1.dta", replace
** Associated YAML metadata file - create and save
   local dataset "${tempdata}\bnr-cvd-count-${today}-prep1.dta"
   * Generate YAML
   bnryaml using "`dataset'", ///
      ...
      source("Hospital admissions (QEH) and national death registration") ///
      contact("ian.hambleton@uwi.edu") /// 
      outfile("${tempdata}/bnr-cvd-count-${today}-prep1.yml")
restore
...
preserve
   ...
   note : Date created = ${todayiso}
   note : Input dataset created by J.Campbell, 25-Oct-2025 
   save "${tempdata}\bnr-cvd-case-fatality-${today}-prep1.dta", replace
** Associated YAML metadata file - create and save
   local dataset "${tempdata}\bnr-cvd-case-fatality-${today}-prep1.dta"
   * Generate YAML
   bnryaml using "`dataset'", ///
      ...
      source("Hospital admissions (QEH) and national death registration") ///
      contact("ian.hambleton@uwi.edu") /// 
      outfile("${tempdata}/bnr-cvd-case-fatality-${today}-prep1.yml")
restore
...
preserve
   ...
   note : Date created = ${todayiso}
   note : Input dataset created by J.Campbell, 25-Oct-2025 
   save "${tempdata}\bnr-cvd-length-of-stay-${today}-prep1.dta", replace
** Associated YAML metadata file - create and save
   local dataset "${tempdata}\bnr-cvd-length-of-stay-${today}-prep1.dta"
   * Generate YAML
   bnryaml using "`dataset'", ///
      ...
      source("Hospital admissions (QEH) and national death registration") ///
      contact("ian.hambleton@uwi.edu") /// 
      outfile("${tempdata}/bnr-cvd-length-of-stay-${today}-prep1.yml")
restore
...
**       dmed5
   ...
   note : Date created = ${todayiso}
   note : Input dataset created by J.Campbell, 25-Oct-2025 
   save "${tempdata}\bnr-cvd-performance-${today}-prep1.dta", replace
** Associated YAML metadata file - create and save
   local dataset "${tempdata}\bnr-cvd-performance-${today}-prep1.dta"
   * Generate YAML
   bnryaml using "`dataset'", ///
      title("BNR-CVD COUNT Dataset (Identifiable)") ///
      version("1.0") ///
      ...
      contact("ian.hambleton@uwi.edu") /// 
      outfile("${tempdata}/bnr-cvd-performance-${today}-prep1.yml")
